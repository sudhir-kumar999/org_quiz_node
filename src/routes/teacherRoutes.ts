...
import { allQuizzes, banUsers, changePassword, createQuiz, login, reInvite, studentDetails, studentInvite, uploadCsv } from "../authController/teacherController";
...
teacherRoute.post("/upload-csv",checkLogin,authorize("teacher"),upload.single("file"),uploadCsv);
